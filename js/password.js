    ...
    resultado.innerHTML = `
      ...
      <div style="margin-top:1.25rem;background:var(--azul-suave);border:1px solid rgba(37,99,184,0.15);border-radius:var(--radius-lg);padding:1.1rem 1.25rem;">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:0.5rem;">
          <a href="https://go.nordpass.io/aff_c?offer_id=488&aff_id=141673&url_id=9356&aff_sub=termometro" target="_blank" rel="noopener noreferrer" style="font-family:var(--font-display);font-size:0.78rem;font-weight:700;color:var(--azul-soberano);background:white;border:1px solid rgba(37,99,184,0.2);border-radius:6px;padding:0.35rem 0.75rem;text-decoration:none;">NordPass</a>
