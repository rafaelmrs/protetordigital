    ...
    <div style={{display:'flex',flexDirection:'column',gap:16}}>
      ...
      <div style={S.card}>
        ...
        <div style={{position:'relative'}}>
          ...
          />
          <button onClick={()=>setShow(!show)} title={show?'Ocultar senha':'Mostrar senha'} aria-label={show?'Ocultar senha':'Mostrar senha'} style={{position:'absolute',right:8,top:'50%',transform:'translateY(-50%)',background:'var(--surface2)',border:'1px solid var(--border2)',borderRadius:6,padding:'4px 10px',cursor:'pointer',fontSize:11,color:'var(--text-dim)',fontFamily:'var(--font-mono)',display:'flex',alignItems:'center',gap:5,whiteSpace:'nowrap'}}>
            {show ? (
